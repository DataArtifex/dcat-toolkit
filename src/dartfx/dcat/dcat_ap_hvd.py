...
class Dataset(DcatAPDataset):
    ...
    hvdCategory: Annotated[List[Union[str, URIRef]], RdfProperty(DCATAP.hvdCategory)] = Field(default_factory=list)
    
    def add_hvd_category(self, category: Union[str, URIRef]) -> Union[str, URIRef]:
    ...
    def make_hvd_compliant(self, category: Union[str, URIRef]) -> None:
...
class Distribution(DcatAPDistribution):
    ...
    def is_hvd_compliant(self) -> bool:
        ...
        has_licence = self.license is not None
...
class DataService(DcatAPDataService):
    ...
    # HVD-specific mandatory property
    hvdCategory: Annotated[Optional[List[Union[str, URIRef]]], RdfProperty(DCATAP.hvdCategory)] = Field(default_factory=list)
