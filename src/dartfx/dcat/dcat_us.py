...
from dartfx.rdf.pydantic import dcterms
...
class AccessRestriction(DcatUSResource):
    ...
    restrictionStatus: Annotated[Union[str, URIRef], RdfProperty(DCAT_US.restrictionStatus)]
    
    # Optional properties
    specificRestriction: Annotated[Optional[Union[str, URIRef]], RdfProperty(DCAT_US.specificRestriction)] = None
    restrictionNote: Annotated[Optional[str], RdfProperty(DCAT_US.restrictionNote)] = None
...
class CuiRestriction(DcatUSResource):
    ...
    # Optional properties
    requiredIndicatorPerAuthority: Annotated[Optional[str], RdfProperty(DCAT_US.requiredIndicatorPerAuthority)] = None
...
class LiabilityStatement(DcatUSResource):
    ...
    # Optional properties
    label: Annotated[Optional[List[str]], RdfProperty(Namespace("http://www.w3.org/2000/01/rdf-schema#").label)] = Field(default_factory=list)
    
    def add_label(self, value: str, lang: Optional[str] = None) -> None:
