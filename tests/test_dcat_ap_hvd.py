...
class TestHVDCategory:
    ...
    def test_is_valid_category(self) -> None:
        ...
        assert dcat_ap_hvd.HVDCategory.is_valid_category(dcat_ap_hvd.HVDCategory.GEOSPATIAL)
        assert not dcat_ap_hvd.HVDCategory.is_valid_category("http://invalid.category")


class TestHVDLicence:
    """Test cases for HVD licences."""

    def test_hvd_compliant_licences(self) -> None:
        """Test HVD-compliant licence URIs."""
        assert dcat_ap_hvd.HVDLicence.is_hvd_compliant(dcat_ap_hvd.HVDLicence.CC_BY_4_0)
        assert dcat_ap_hvd.HVDLicence.is_hvd_compliant(dcat_ap_hvd.HVDLicence.CC0_1_0)
        assert dcat_ap_hvd.HVDLicence.is_hvd_compliant(dcat_ap_hvd.HVDLicence.EU_NO_RESTRICTIONS)

    def test_non_compliant_licence(self) -> None:
        """Test non-HVD-compliant licence."""
        assert not dcat_ap_hvd.HVDLicence.is_hvd_compliant("http://example.org/restrictive-licence")


class TestHVDDataset:
    """Test cases for HVD Dataset."""

    def test_create_hvd_dataset(self) -> None:
    ...
    def test_add_hvd_category(self) -> None:
    ...
    def test_make_hvd_compliant(self) -> None:
    ...
    def test_is_hvd_compliant(self) -> None:
    ...
    def test_complete_hvd_dataset(self) -> None:
...
class TestHVDDistribution:
    ...
    def test_create_hvd_distribution(self) -> None:
    ...
    def test_complete_hvd_distribution(self) -> None:
...
class TestHVDDataService:
    ...
    def test_create_hvd_data_service(self) -> None:
...
class TestHVDDatasetSeries:
    ...
    def test_create_hvd_dataset_series(self) -> None:
...
class TestRdfSerialization:
    ...
    def test_dataset_to_turtle(self) -> None:
...
class TestCompleteHVDExample:
    ...
    def test_complete_hvd_catalog(self) -> None:
    ...
    def test_hvd_with_multiple_categories(self) -> None:
    ...
    def test_serialize_complete_hvd_structure(self) -> None:
